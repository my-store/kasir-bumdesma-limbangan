...
import "../../../scss/persediaan/pupuk-subsidi/daftar.scss";
    ...
    return (
      <div className="pupuk-subsidi">
        <p className="title" style={{ backgroundColor: theme }}>
          <span className="label">PUPUK SUBSIDI</span>
          <span className="stok">
            Stok
        ...
        <div className="aksi">
          <div className="btns">
            <div
              className="button"
              onClick={() => {
                openInsertForm({ id: "PupukSubsidi" });
                setTimeout(() => {
                  $("#insert-pupuk-subsidi-form .nama-barang").focus();
                }, 1000);
              }}
            >
              <FiPlus size={16} />
          ...
          <div
            className={
              searchBox.pupukSubsidi
                ? "search-pupuk-subsidi-container search-pupuk-subsidi-container-active"
                : "search-pupuk-subsidi-container"
            }
          >
            {searchBox.pupukSubsidi ? (
              <CariPupuk
                search={(key) => searchData(key, "PupukSubsidi")}
                close={() =>
                  closeSearchBox({
                    id: "PupukSubsidi",
                    state: { pupukSubsidi: false },
                  })
                }
              />
            ) : null}
